...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Almarai:wght@300;400;700;800&family=Aref+Ruqaa:wght@400;700&family=Oxanium:wght@200..800&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Almarai:wght@300;400;700;800&family=Aref+Ruqaa:wght@400;700&display=swap" rel="stylesheet">
        ...
        <div class="tm_invoice_wrap">
            <div class="tm_invoice tm_style1 tm_type3" id="tm_download_section">
                <div class="tm_shape_1">
                    <svg width="100%" height="151" viewBox="0 0 850 151" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tm_invoice_in mt-5">
                    <div class="tm_invoice_head tm_align_center tm_mb20">
                        <div class="tm_invoice_left">
                            <div class="tm_logo"><img src="logo.png" alt="Logo"></div>
                        </div>
                    </div>
                    <div class="tm_invoice_info tm_mb20 tm_invoice_right">
                        <div class="tm_invoice_info_list">
                            <p class="tm_invoice_number tm_m0">Invoice number: <b class="tm_primary_color" dir="ltr">#784</b></p>
                            <p class="tm_invoice_date tm_m0">Date: <b class="tm_primary_color">27.10.2024</b></p>
                            <div class="tm_invoice_info_list_bg tm_accent_bg_10"></div>
                        </div>
                    </div>

                    <div class="tm_invoice_head tm_mb10 mt-5">
                        <div class="tm_invoice_left">
                            <p class="tm_mb2"><b class="tm_primary_color">Invoice details:</b></p>
                            <p>
                                Ahmed Yahya <br>
                                +9655256985 <br>
                                lowell@gmail.com <br>
                        ...
                        <div class="tm_invoice_right tm_text_right">
                            ...
                            <p>
                                Farwaniya / Seville <br>
                                Plot: 312 <br>
                                Street: 121 <br>
                                Building: 321 <br>
                                Address Details: Kuwait Kuwait City
                            </p>
                        </div>
                    </div>
                    <div class="tm_table tm_style1 tm_mb30 mt-5">
                        <div class="tm_table_responsive">
                            <table class="tm_border_bottom">
                                <thead>
                                    <tr class="tm_border_top">
                                        <th class="tm_width_5 tm_semi_bold tm_primary_color tm_accent_bg_10">Item</th>
                                        <th class="tm_width_2 tm_semi_bold tm_primary_color tm_accent_bg_10">Price</th>
                                        <th class="tm_width_2 tm_semi_bold tm_primary_color tm_accent_bg_10">selling price</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="tm_width_5">001</td>
                                        <td class="tm_width_2">250.000</td>
                                        <td class="tm_width_2">250.000</td>
                                        <td class="tm_width_1">1</td>
                                        <td class="tm_width_2 tm_text_right">250.000</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_5">002</td>
                                        <td class="tm_width_2">250.000</td>
                                        <td class="tm_width_2">250.000</td>
                                        <td class="tm_width_1">1</td>
                                        <td class="tm_width_2 tm_text_right">250.000</td>
                        ...
                        <hr>
                        <div class="tm_invoice_footer mt-5">
                            <div class="tm_table_responsive mt-5">
                                <table class="tm_border_bottom">
                                    <thead>
                                        <tr class="tm_border_top">
                                            <th class="tm_width_1 tm_semi_bold tm_primary_color tm_accent_bg_10">Full amount:</th>
                                            <th class="tm_width_1 tm_semi_bold tm_primary_color tm_accent_bg_10">Amount paid:</th>
                                            <th class="tm_width_1 tm_semi_bold tm_primary_color tm_accent_bg_10 tm_text_right">remaining amount</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="tm_width_1 tm_semi_bold">250.000</td>
                                            <td class="tm_width_1 tm_semi_bold">250.000</td>
                                            <td class="tm_width_1 tm_semi_bold">0.000</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="tm_invoice_left flex mt-50">
                        <div class="tm_flex_row tm_col_6">
            ...
            <div class="tm_invoice tm_style1 tm_type3 mt-5" id="tm_download_section">
                <div class="tm_invoice_in mt-5">
                    <div class="tm_invoice_head tm_align_center tm_mb20">
                        <div class="tm_invoice_left">
                            <div class="tm_logo"><img src="logo.png" alt="Logo"></div>
                    ...
                    <div class="tm_invoice_right w100 mt-1">
                        <div class="tm_grid_row tm_col_4  tm_col_2_sm tm_invoice_table tm_round_border">
                            <div>
                                <p class="tm_m0 tm_semi_bold">Customer Name:</p>
                                <b class="tm_primary_color_gray">....................................</b>
                            </div>

                            <div>
                                <p class="tm_m0 tm_semi_bold">phone number:</p>
                                <b class="tm_primary_color_gray">....................................</b>
                            </div>
                            <div>
                                <p class="tm_m0 tm_semi_bold">Order date:</p>
                                <b class="tm_primary_color_gray">....................................</b>
                            </div>
                            <div>
                                <p class="tm_m0 tm_semi_bold">Date of receipt:</p>
                                <b class="tm_primary_color_gray">....................................</b>
                            </div>
                        </div>
                    </div>
                    <div class="tm_table tm_style1 tm_mb30 mt-1">
                        <div class="tm_padd_15_20 tm_gray_bg">
                            <p class="tm_mb5"><b class="tm_primary_color">First, regarding dresses for sale and tailoring:</b></p>
                            <p class="tm_m0 tm_note_list">

                                1- If the work is entrusted to the supplier to detail a specific type of dresses or other, the supplier shall not be obligated to implement it except within the limits, sizes and model standards agreed upon between the two parties, and the customer has the right to request any modification of what was previously mentioned at all except with the approval of the supplier. The modification fees may be added, which he specifies, and the customer is obligated to pay them before making any modifications. <br>

                                2- Once the customer signs this form, the contract is considered valid between the two parties. If the customer withdraws from the contract, he loses the deposit paid and has no right under any circumstances to demand the supplier to return it.
                                <br>

                                -3 The worker has the right to three days from receipt if he requests the installer to make some minor adjustments to adjust the measurements only. If the adjustments he requests require the installer to perform work that is not agreed upon, such as changing the method of detailing or adding tools that were not agreed upon, the installer has the right to refrain from making any adjustments or requesting fees for the adjustment, and the worker is obligated to pay them before implementation. <br>
                                -4 If the customer fails to attend to receive the dress within 11 days from the agreed date of receipt after the delivery company notifies him of the necessity of attending to receive it by means of a message stating the customer number written on the form, the customer is considered to have withdrawn from the agreementand thus loses the deposit, which in this case is considered to be disposing of the dress on his own account to compensate for his loss.  <br>

                                -5 In all cases, the customer’s receipt of the dress is considered an acknowledgment from him that he received it in excellent condition and in accordance with his desires and he has the right to dispute any of the above in the future.
 <br>
                                -6 The customer acknowledges that he has reviewed these terms and conditions and is aware of their content and meaning before signing this form and before dealing with the delivery company based on it. <br>
                    ...
                    <div class="tm_invoice_left flex">
                        <div class="tm_flex_row tm_col_6">
                            <div class="tm_text_left">
                                <b>Customer Signature</b> <br>
                                ..............................................................
            ...
            <div class="tm_invoice tm_style1 tm_type3 mt-5" id="tm_download_section">
                <div class="tm_invoice_in mt-5">
                    ...
                    <div class="tm_invoice_right w100 ">
                    ...
                    <div class="tm_table tm_style1 flex_table w100 tm_mb30 mt-1">
                        <div class="tm_table_responsive">
                            <table class="tm_border_bottom w100">
                                <thead>
                                    <tr class="tm_border_top">
                                        <th class="tm_width_3 tm_semi_bold tm_primary_color tm_accent_bg_10">Size</th> <th class="tm_width_1 tm_semi_bold tm_primary_color tm_accent_bg_10">Length</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">perimeter</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Wrist perimeter</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_wid3h_3 tm_semi_bold">Armpit perimeter</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">upper chest</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Full length dress</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Chest opening</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Length from waist to hip</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Sleeve Length</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Length from waist to knee</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Shoulder width</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Length from shoulder to hip</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Hip perimeter</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Length from shoulder to waist</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">shoulder rotation</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Under chest perimeter </td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Chest perimeter</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">waistline </td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Ulnar perimeter</td>
                                        <td class="tm_width_1 tm_semi_bold">1.1</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_3 tm_semi_bold">Notes</td>
                                        <td class="tm_width_2 tm_semi_bold"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
